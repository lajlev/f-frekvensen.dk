...
?>
    ...
    <?php if(rwmb_meta( 'hurry_post_sidebar') == "1"): $classes = array('three_fourth','container-column','post-status'); else: $classes = array('container-column','post-status'); endif; ?>
...
?>
    <!-- // A POST // --> 
    <div class="post post-status masonry-item view <?php if(is_sticky()): ?>sticky<?php endif;?>">

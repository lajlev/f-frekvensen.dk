		...
		case "images":
			...
			foreach ($value['options'] as $key => $option) 
			 ...
			 $i++;
				...
				$output .= '<div style="background: url(\''.$option.'\') repeat; height: 50px; width: 50px;"  class="of-radio-img-img '. $selected .'" onClick="document.getElementById(\'of-radio-img-'. $value['id'] . $i.'\').checked = true;"></div>';
				$output .= '</span>';

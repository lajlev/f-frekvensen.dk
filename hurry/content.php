...
if ( is_single() ) {
?>
    <?php if(rwmb_meta( 'hurry_post_sidebar') == "1"): $classes = array('three_fourth','container-column'); else: $classes = array('container-column'); endif; ?>
...
?>
    <!-- // A POST // -->
    <div class="post post-normal masonry-item view <?php if(is_sticky()): ?>sticky<?php endif;?>">

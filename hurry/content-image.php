...
if ( is_single() ) {
?>
    <?php if(rwmb_meta( 'hurry_post_sidebar') == "1"): $classes = array('three_fourth','container-column','post-image'); else: $classes = array('container-column','post-image'); endif; ?>
    <article id="post-<?php the_ID(); ?>" <?php post_class($classes); ?>>
        ...
        <div class="container-content">
            <div class="container-padding">
                <a href="<?php echo $image_url; ?>" data-rel="prettyPhoto"><h1><?php the_title(); ?></h1></a>
                <p><?php the_content()?></p>
...
?>
    <!-- // A POST // -->
    <div class="post post-image masonry-item view <?php if(is_sticky()): ?>sticky<?php endif;?>">

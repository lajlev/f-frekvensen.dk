...
?>
    ...
    <?php if(rwmb_meta( 'hurry_post_sidebar') == "1"): $classes = array('three_fourth','container-column','post-aside'); else: $classes = array('container-column','post-aside'); endif; ?>
...
?>
    <!-- // A POST // -->
    <div class="post post-aside masonry-item view <?php if(is_sticky()): ?>sticky<?php endif;?>">
        ...
        <div class="container-content">
            ...
            <?php if( rwmb_meta('hurry_post_meta') == "1"): ?>
                ...
                <div id="postmetadata">
                    ...
                    <a href="<?php echo get_permalink( $id ); ?>" class="button"><?php _e('Læs mere','hurry'); ?>   <span class="icon">&oplus;</span></a>
